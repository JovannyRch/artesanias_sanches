                ...
                <tbody>
                    <?php foreach ($clientes as $cliente) { ?>
                        ...
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <?php echo $cliente['nombre'] . " " . $cliente['ap_paterno'] . " " . $cliente['ap_materno'] ?>
                            </td>
                            <td class="px-6 py-4">
                                <a href="./AOAAdminReporteDetalle.php?id=<?php echo $cliente['id_cliente'] ?>" class="bg-blue-500 text-white p-2 rounded">Ver detalle</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
