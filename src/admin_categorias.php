...
<body class="dark:text-slate-400 bg-white dark:bg-slate-900 min-h-screen">
    ...
    <div class="container p-8 gap-8 w-full">
        <h2 class="relative group font-bold text-3xl mb-4">Categorias</h2>
                ...
                <tbody>
                    ...
                    <?php foreach ($categorias as $categoria) { ?>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <a href="./admin_editar_categoria.php?id=<?= $categoria['id'] ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                    Editar
                                </a>
                            </td>
                        </tr>
